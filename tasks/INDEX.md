...
- 完成验证后，将 ⬜ 改为 ✅，并将任务 frontmatter 的 `status` 改为 `done`；无法在当前环境完成的任务使用 ⚠️ 并记录阻塞原因。
...
| 010 | ⚠️ | [O610 Optional：验收 5–8 小时通关后内容](./08-optional/O610-optional-postgame-acceptance.md) | O601、O602、O603、O604、O605、O606、O607、O608、O609 | Optional |
