---
id: C351
title: 第6章 东海镇：场景、NPC 与素材
phase: chapter-content
depends_on: [C343, W201, W204, W205, W209]
status: done
...
建立第6章“东海镇”的可进入场景、状态化 NPC、探索热点和全部本地素材；本任务不编写完整任务线或 Boss 逻辑。

## 必读

- `tasks/README.md`
- `docs/PLAN_v2.md`：第 3 节主线结构、第 8 节资源预算
- `src/content/chapters/ch06/`（若存在）与前一章内容模式

## 实现范围

- 生成东海镇港口场景、至少 3 名 NPC 与海潮帮主/普通敌人本地 WebP。
...
- 已完成第6章东海镇区域、3个地点、3名状态化 NPC、3个探索热点、2个返回热点、采集点与章节入口条件。
